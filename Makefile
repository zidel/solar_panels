...
data/.score_solar_area.marker : data/solar_area.hdf5 Makefile
	./in_container.sh python3 score_tiles.py --load-model=data/solar_area.hdf5 --feature=solar_area
	touch data/.score_solar_area.marker
